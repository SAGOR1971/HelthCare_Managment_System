...
<head>
    ...
    <title>Modern Healthcare Store</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <h1>Welcome to Healthcare Store</h1>
            <p>Discover quality healthcare products for your well-being</p>
        </div>
    </div>
        ...
        <div class="product-grid">
            ...
            if (!$hasProducts) {
                ...
                <div class='no-products'>
                    ...
                    <p>We're currently updating our featured products. Please check our other categories or come back later.</p>
                    <div class='category-buttons'>
                        <a href='Medicine.php' class='btn btn-primary'>
                            <i class='fas fa-pills'></i> Browse Medicines
                        </a>
                        <a href='Equipment.php' class='btn btn-primary'>
                            <i class='fas fa-tools'></i> View Equipment
                        </a>
                        <a href='Syrup.php' class='btn btn-primary'>
                            <i class='fas fa-prescription-bottle'></i> Shop Syrups
                        </a>
                    </div>
                </div>";
            }
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="product-info">
                            <p><i class="fas fa-box"></i> <span id="modalCategory">Category: Home</span></p>
