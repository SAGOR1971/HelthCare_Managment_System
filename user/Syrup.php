...
<head>
    ...
    <title>Syrup Products - Healthcare Store</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <h1>Syrup Products</h1>
            <p>Browse our wide selection of quality syrups</p>
        </div>
    </div>
        ...
        <div class="product-grid">
            ...
            if (!$hasProducts) {
                ...
                <div class='no-products'>
                    ...
                    <h2>No Syrups Available</h2>
                    <p>We're currently updating our syrup inventory. Please check back later.</p>
                </div>";
            }
            ?>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="product-info">
                            <p><i class="fas fa-box"></i> <span>Category: Syrup</span></p>
