...
<head>
    ...
    <title>Medicine - Healthcare Store</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            ...
            <p>Browse our wide selection of quality medicines</p>
        </div>
    </div>
        ...
        <div class="product-grid">
            ...
            if (!$hasProducts) {
                ...
                <div class='no-products'>
                    ...
                    <p>We're currently updating our medicine inventory. Please check back later.</p>
                </div>";
            }
            ?>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="product-info">
                            <p><i class="fas fa-box"></i> <span>Category: Medicine</span></p>
