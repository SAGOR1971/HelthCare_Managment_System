            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown pe-3">
                    ...
                    <ul class="dropdown-menu bg-dark" aria-labelledby="doctorsDropdown">
                        ...
                        <li><a class="dropdown-item text-warning" href="chat.php">Chat with Doctor AI</a></li>
                    </ul>
                </div>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <?php if(isset($_SESSION['user'])): ?>
                            <ul class="dropdown-menu bg-dark" aria-labelledby="userDropdown">
                                <li>
                                    <a class="dropdown-item text-warning" href="update_profile.php">
                                        <i class="fas fa-user-edit"></i> Update Profile
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item text-warning" href="order_status.php">
